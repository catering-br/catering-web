...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { quantity: @cart_item.quantity, shopping_cart_id: @cart_item.shopping_cart_id, unitary_price: @cart_item.unitary_price } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { quantity: @cart_item.quantity, shopping_cart_id: @cart_item.shopping_cart_id, unitary_price: @cart_item.unitary_price } }
